---
title: 自定义引导程序
createTime: 2025/06/19 09:37:53
permalink:  /notes/knowledge/document/Caliburn.Micro/9g6cm461/
tags: [Caliburn.Micro, WPF, C#, .net]
---

在 [基本配置、操作和约定](/knowledge/document/Caliburn.Micro/rukpdvfg/) 中，讨论了 Caliburn.Micro WPF 应用程序的最基本配置，并演示了一些与操作和约定相关的简单功能。在这一部分中，想进一步探索 Bootstrapper 类。
