---
title: 基本配置、操作和约定
createTime: 2025/06/19 09:37:02
permalink:  /notes/knowledge/document/Caliburn.Micro/rukpdvfg/
tags: [Caliburn.Micro, WPF, C#, .net]
---

### 创建一个新的项目

创建一个新的项目，根据 [快速开始#构建项目](/knowledge/document/Caliburn.Micro/fcbckcpl/#构建项目) 中描述的，完成相关的配置，并修改相关文件的内容
